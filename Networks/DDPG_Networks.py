...
class DDPG_CriticNetwork(nn.Module):
    def __init__(self, critic_lr, input_dims, C_fc_dims_list, activation, squash, initialize, n_actions):
        super(DDPG_CriticNetwork, self).__init__()
        #Initialize
...
class DDPG_ActorNetwork(nn.Module):
    ...
    def forward(self, state):
        ...
        action_params = T.tanh(self.action_output_layer(x))
